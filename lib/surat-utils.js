...
function domisiliTemplate({ nama, nik, tanggalLahir, noWa, dusun, rt, rw, desa, kecamatan, kabupaten, provinsi }) {
  ...
  return [
    ...
    { text: "SURAT KETERANGAN DOMISILI", x: 160, y: 780, size: 16 },
    ...
    { text: "Benar berdomisili di alamat tersebut di atas.", x: 50, y: y - 50, size: 12 },
    { text: "Demikian surat ini dibuat untuk dipergunakan sebagaimana mestinya.", x: 50, y: y - 70, size: 12 },
    // Ruang tanda tangan bawah lebih rapi
    { text: tanggalSurat, x: xKanan, y: yTtd, size: 12 },
    { text: "Pemohon", x: xKiri, y: yTtd, size: 12 },
    { text: "Penanda Tangan", x: xKanan, y: yTtd - 20, size: 12 },
    { text: "( QR / Cap )", x: xKiri, y: yTtd - 20, size: 10 },
    { text: "( Tanda Tangan )", x: xKanan, y: yTtd - 40, size: 10 },
    { text: nama, x: xKiri, y: yTtd - 60, size: 12 },
  ];
}
...
function usahaTemplate({ nama, nik, tanggalLahir, noWa, dusun, rt, rw, desa, kecamatan, kabupaten, provinsi }) {
  ...
  return [
    { text: "PEMERINTAH DESA/KELURAHAN", x: 180, y: 800, size: 12 },
    { text: "SURAT KETERANGAN USAHA", x: 170, y: 780, size: 16 },
    { text: "Yang bertanda tangan di bawah ini menerangkan:", x: 50, y: 740, size: 12 },
    { text: `Nama           : ${nama}`, x: 50, y: 720, size: 12 },
    { text: `NIK            : ${nik}`, x: 50, y: 700, size: 12 },
    { text: `Tanggal Lahir  : ${tanggalLahir ? new Date(tanggalLahir).toLocaleDateString('id-ID') : '-' }`, x: 50, y: 680, size: 12 },
    ...alamatFields,
    { text: `No. WhatsApp   : ${noWa || '-'}`, x: 50, y: y - 20, size: 12 },
    { text: "Benar memiliki usaha di alamat tersebut.", x: 50, y: y - 50, size: 12 },
    { text: "Surat ini dibuat untuk keperluan administrasi usaha.", x: 50, y: y - 70, size: 12 },
    { text: tanggalSurat, x: xKanan, y: yTtd, size: 12 },
    { text: "Pemohon", x: xKiri, y: yTtd, size: 12 },
    { text: "Penanda Tangan", x: xKanan, y: yTtd - 20, size: 12 },
    { text: "( QR / Cap )", x: xKiri, y: yTtd - 20, size: 10 },
...
function tidakMampuTemplate({ nama, nik, tanggalLahir, noWa, dusun, rt, rw, desa, kecamatan, kabupaten, provinsi }) {
  ...
  return [
    { text: "PEMERINTAH DESA/KELURAHAN", x: 180, y: 800, size: 12 },
    { text: "SURAT KETERANGAN TIDAK MAMPU", x: 140, y: 780, size: 16 },
    { text: "Yang bertanda tangan di bawah ini menerangkan:", x: 50, y: 740, size: 12 },
    { text: `Nama           : ${nama}`, x: 50, y: 720, size: 12 },
    { text: `NIK            : ${nik}`, x: 50, y: 700, size: 12 },
    { text: `Tanggal Lahir  : ${tanggalLahir ? new Date(tanggalLahir).toLocaleDateString('id-ID') : '-' }`, x: 50, y: 680, size: 12 },
    ...alamatFields,
    { text: `No. WhatsApp   : ${noWa || '-'}`, x: 50, y: y - 20, size: 12 },
    { text: "Benar merupakan warga tidak mampu.", x: 50, y: y - 50, size: 12 },
    { text: "Surat ini dibuat untuk keperluan bantuan sosial.", x: 50, y: y - 70, size: 12 },
    { text: tanggalSurat, x: xKanan, y: yTtd, size: 12 },
    { text: "Pemohon", x: xKiri, y: yTtd, size: 12 },
    { text: "Penanda Tangan", x: xKanan, y: yTtd - 20, size: 12 },
    { text: "( QR / Cap )", x: xKiri, y: yTtd - 20, size: 10 },
...
function kelahiranTemplate({ nama, nik, tanggalLahir, noWa, dusun, rt, rw, desa, kecamatan, kabupaten, provinsi, kepalaDesa }) {
  ...
  return [
    { text: "PEMERINTAH DESA/KELURAHAN", x: 180, y: 800, size: 12 },
    { text: "SURAT KETERANGAN KELAHIRAN", x: 150, y: 780, size: 16 },
    { text: "Yang bertanda tangan di bawah ini menerangkan:", x: 50, y: 740, size: 12 },
    { text: `Nama Anak       : ${nama}`, x: 50, y: 720, size: 12 },
    { text: `NIK Anak        : ${nik}`, x: 50, y: 700, size: 12 },
    { text: `Tanggal Lahir   : ${tanggalLahir ? new Date(tanggalLahir).toLocaleDateString('id-ID') : '-'}`, x: 50, y: 680, size: 12 },
    ...alamatFields,
    { text: `No. WhatsApp    : ${noWa || '-'}`, x: 50, y: y - 20, size: 12 },
    { text: "Benar telah lahir di alamat tersebut.", x: 50, y: y - 50, size: 12 },
    { text: "Surat ini dibuat untuk keperluan administrasi kependudukan.", x: 50, y: y - 70, size: 12 },
    { text: tanggalSurat, x: xKanan, y: yTtd + 50, size: 12 },
    { text: "Pemohon", x: xKiri, y: yTtd + 30, size: 12 },
    { text: "Mengetahui,", x: xKanan, y: yTtd + 30, size: 12 },
    { text: "( QR / Cap )", x: xKiri, y: yTtd + 10, size: 10 },
    { text: "Kepala Desa", x: xKanan, y: yTtd + 10, size: 12 },
    { text: nama, x: xKiri, y: yTtd - 80, size: 12 },
    { text: kepalaDesa || "Nama Kepala Desa", x: xKanan, y: yTtd - 80, size: 12 },
  ];
}
...
function pengantarKtpTemplate({ nama, nik, tanggalLahir, noWa, dusun, rt, rw, desa, kecamatan, kabupaten, provinsi }) {
  ...
  return [
    { text: "PEMERINTAH DESA/KELURAHAN", x: 180, y: 800, size: 12 },
    { text: "SURAT PENGANTAR KTP", x: 180, y: 780, size: 16 },
    { text: "Yang bertanda tangan di bawah ini menerangkan:", x: 50, y: 740, size: 12 },
    { text: `Nama           : ${nama}`, x: 50, y: 720, size: 12 },
    { text: `NIK            : ${nik}`, x: 50, y: 700, size: 12 },
    { text: `Tanggal Lahir  : ${tanggalLahir ? new Date(tanggalLahir).toLocaleDateString('id-ID') : '-' }`, x: 50, y: 680, size: 12 },
    ...alamatFields,
    { text: `No. WhatsApp   : ${noWa || '-'}`, x: 50, y: y - 20, size: 12 },
    { text: "Benar merupakan warga yang akan mengurus KTP.", x: 50, y: y - 50, size: 12 },
    { text: "Surat ini dibuat untuk keperluan pengajuan KTP.", x: 50, y: y - 70, size: 12 },
    { text: tanggalSurat, x: xKanan, y: yTtd, size: 12 },
    { text: "Pemohon", x: xKiri, y: yTtd, size: 12 },
    { text: "Penanda Tangan", x: xKanan, y: yTtd - 20, size: 12 },
    { text: "( QR / Cap )", x: xKiri, y: yTtd - 20, size: 10 },
...
function defaultTemplate({ nama, nik, alamat, tanggalLahir, noWa }) {
  ...
  return [
    { text: `Surat: ${nama || "-"}` , x: 50, y: 780, size: 18 },
